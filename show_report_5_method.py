...
csv_filename = "data/policy_comparison_results_5_method.csv"
...
linestyles = {
    ...
    "Combination": "-.",
    "PPO": ":",
    "Q-Learning": (0, (3, 1, 1, 1))  # kiểu nét chấm gạch
}
colors = {
    "First-Fit": "r",
    "Best-Fit": "g",
    "Combination": "b",
    "PPO": "orange",
    "Q-Learning": "purple"  # <-- sửa lại thành 'Q-Learning'
}
...
plot_filename = "results/comparison_5_method.png"
plt.tight_layout()
